...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-param, you can start by going to its [fork page](https://github.com/canjs/can-param/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-param
```
