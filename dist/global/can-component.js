...
/*can-reflect@0.0.3#reflections/type/type*/
...
/*can-reflect@0.0.3#reflections/call/call*/
...
/*can-reflect@0.0.3#reflections/get-set/get-set*/
...
/*can-reflect@0.0.3#reflections/observe/observe*/
...
/*can-reflect@0.0.3#reflections/shape/shape*/
...
/*can-observation@3.2.0-pre.10#can-observation*/
...
/*can-observation@3.2.0-pre.10#reader/reader*/
...
/*can-compute@3.1.0-pre.7#single-reference*/
...
/*can-compute@3.1.0-pre.7#proto-compute*/
define('can-compute/proto-compute', function (require, exports, module) {
    ...
    canReflect.set(Compute.prototype, canSymbol.for('can.valueHasDependencies'), function () {
        return this.observation && canReflect.valueHasDependencies(this.observation);
    });
...
/*can-compute@3.1.0-pre.7#can-compute*/
...
/*can-control@3.1.0-pre.0#can-control*/
...
/*can-component@3.0.7#control/control*/
...
/*can-view-scope@3.2.0-pre.9#reference-map*/
...
/*can-view-scope@3.2.0-pre.9#compute_data*/
...
/*can-view-scope@3.2.0-pre.9#can-view-scope*/
...
/*can-stache@3.1.0-pre.2#src/utils*/
...
/*can-view-parser@3.3.0#can-view-parser*/
...
/*can-view-live@3.1.0-pre.3#lib/core*/
...
/*can-view-callbacks@3.0.7-pre.1#can-view-callbacks*/
...
/*can-view-live@3.1.0-pre.3#lib/attrs*/
...
/*can-view-live@3.1.0-pre.3#lib/util/runInOrder*/
...
/*can-view-live@3.1.0-pre.3#lib/list*/
...
/*can-view-live@3.1.0-pre.3#lib/text*/
...
/*can-view-live@3.1.0-pre.3#can-view-live*/
...
/*can-stache@3.1.0-pre.2#helpers/core*/
...
/*can-stache@3.1.0-pre.2#src/expression*/
...
/*can-view-model@3.3.0-pre.1#can-view-model*/
...
/*can-event-radiochange@0.1.1#can-event-radiochange*/
...
/*can-event-radiochange@0.1.1#override*/
...
/*can-stache-bindings@3.2.0-pre.0#can-stache-bindings*/
...
/*can-component@3.0.7#can-component*/
