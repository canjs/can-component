...
/*can-util@3.9.1#js/assign/assign*/
...
/*can-util@3.9.1#js/is-array/is-array*/
...
/*can-util@3.9.1#js/is-function/is-function*/
...
/*can-util@3.9.1#js/is-plain-object/is-plain-object*/
...
/*can-util@3.9.1#js/deep-assign/deep-assign*/
...
/*can-util@3.9.1#js/is-array-like/is-array-like*/
...
/*can-util@3.9.1#js/is-iterable/is-iterable*/
...
/*can-util@3.9.1#js/make-array/make-array*/
...
/*can-util@3.9.1#js/is-container/is-container*/
...
/*can-util@3.9.1#js/string/string*/
...
/*can-reflect@1.0.3#reflections/type/type*/
...
/*can-reflect@1.0.3#reflections/call/call*/
...
/*can-reflect@1.0.3#reflections/get-set/get-set*/
...
/*can-reflect@1.0.3#reflections/observe/observe*/
...
/*can-reflect@1.0.3#reflections/shape/shape*/
...
/*can-util@3.9.1#js/is-empty-object/is-empty-object*/
...
/*can-util@3.9.1#js/global/global*/
...
/*can-util@3.9.1#dom/document/document*/
...
/*can-util@3.9.1#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.9.1#js/cid-set/cid-set*/
...
/*can-util@3.9.1#dom/mutation-observer/document/document*/
...
/*can-util@3.9.1#dom/class-name/class-name*/
...
/*can-util@3.9.1#js/is-browser-window/is-browser-window*/
...
/*can-util@3.9.1#dom/events/events*/
...
/*can-util@3.9.1#dom/dispatch/dispatch*/
...
/*can-util@3.9.1#dom/matches/matches*/
...
/*can-util@3.9.1#dom/events/delegate/delegate*/
...
/*can-util@3.9.1#js/single-reference/single-reference*/
...
/*can-util@3.9.1#dom/events/delegate/enter-leave*/
...
/*can-util@3.9.1#js/cid-map/cid-map*/
...
/*can-observation@3.3.0-pre.1#can-observation*/
...
/*can-reflect@1.1.0-pre.3#reflections/type/type*/
define('can-reflect/reflections/type/type', function (require, exports, module) {
    var canSymbol = require('can-symbol');
    var check = function (symbols, obj) {
        for (var i = 0, len = symbols.length; i < len; i++) {
...
/*can-reflect@1.1.0-pre.3#reflections/call/call*/
define('can-reflect/reflections/call/call', function (require, exports, module) {
    var canSymbol = require('can-symbol');
    var typeReflections = require('can-reflect/reflections/type/type');
    module.exports = {
...
/*can-reflect@1.1.0-pre.3#reflections/get-set/get-set*/
define('can-reflect/reflections/get-set/get-set', function (require, exports, module) {
    var canSymbol = require('can-symbol');
    var typeReflections = require('can-reflect/reflections/type/type');
    var setKeyValueSymbol = canSymbol.for('can.setKeyValue'), getKeyValueSymbol = canSymbol.for('can.getKeyValue'), getValueSymbol = canSymbol.for('can.getValue'), setValueSymbol = canSymbol.for('can.setValue');
...
/*can-reflect@1.1.0-pre.3#reflections/observe/observe*/
define('can-reflect/reflections/observe/observe', function (require, exports, module) {
    var canSymbol = require('can-symbol');
    var slice = [].slice;
    function makeFallback(symbolName, fallbackName) {
...
/*can-reflect@1.1.0-pre.3#reflections/shape/shape*/
define('can-reflect/reflections/shape/shape', function (require, exports, module) {
    var canSymbol = require('can-symbol');
    var getSetReflections = require('can-reflect/reflections/get-set/get-set');
    var typeReflections = require('can-reflect/reflections/type/type');
...
/*can-reflect@1.1.0-pre.3#can-reflect*/
define('can-reflect', function (require, exports, module) {
    var functionReflections = require('can-reflect/reflections/call/call');
    var getSet = require('can-reflect/reflections/get-set/get-set');
    var observe = require('can-reflect/reflections/observe/observe');
...
/*can-util@3.9.1#js/is-promise-like/is-promise-like*/
...
/*can-reflect-promise@1.1.0-pre.0#can-reflect-promise*/
...
/*can-compute@3.3.0-pre.1#proto-compute*/
...
/*can-compute@3.3.0-pre.1#can-compute*/
...
/*can-control@3.2.0-pre.0#can-control*/
...
/*can-component@3.2.0-pre.0#control/control*/
...
/*can-simple-map@3.3.0-pre.2#can-simple-map*/
...
/*can-view-scope@3.3.0-pre.3#reference-map*/
...
/*can-view-scope@3.3.0-pre.3#compute_data*/
...
/*can-view-scope@3.3.0-pre.3#can-view-scope*/
...
/*can-stache@3.2.0-pre.0#src/utils*/
...
/*can-util@3.9.1#dom/child-nodes/child-nodes*/
...
/*can-util@3.9.1#dom/contains/contains*/
...
/*can-util@3.9.1#dom/mutate/mutate*/
...
/*can-util@3.9.1#dom/fragment/fragment*/
...
/*can-util@3.9.1#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.9.1#dom/events/make-mutation-event/make-mutation-event*/
...
/*can-util@3.9.1#dom/events/removed/removed*/
...
/*can-view-live@3.2.0-pre.0#lib/core*/
...
/*can-util@3.9.1#dom/events/attributes/attributes*/
...
/*can-view-live@3.2.0-pre.0#lib/attr*/
...
/*can-view-callbacks@3.2.0-pre.0#can-view-callbacks*/
...
/*can-view-live@3.2.0-pre.0#lib/attrs*/
...
/*can-view-live@3.2.0-pre.0#lib/html*/
...
/*can-view-live@3.2.0-pre.0#lib/util/runInOrder*/
...
/*can-view-live@3.2.0-pre.0#lib/list*/
...
/*can-view-live@3.2.0-pre.0#lib/text*/
...
/*can-view-live@3.2.0-pre.0#can-view-live*/
...
/*can-util@3.9.1#js/base-url/base-url*/
...
/*can-util@3.9.1#js/parse-uri/parse-uri*/
...
/*can-util@3.9.1#js/join-uris/join-uris*/
...
/*can-stache@3.2.0-pre.0#helpers/core*/
...
/*can-stache@3.2.0-pre.0#src/expression*/
...
/*can-view-model@3.4.0-pre.0#can-view-model*/
...
/*can-event-dom-enter@1.0.0#can-event-dom-enter*/
...
/*can-event-dom-enter@1.0.0#compat*/
...
/*can-stache-bindings@3.4.0-pre.0#can-stache-bindings*/
        ...
        viewModel: function (el, tagData, makeViewModel, initialViewModelData, staticDataBindingsOnly) {
            ...
            if (!bindingsState.isSettingViewModel) {
                domEvents.addEventListener.call(el, 'attributes', function (ev) {
                    ...
                    console.log('attribute', attrName, 'is', value);
...
/*can-component@3.2.0-pre.0#can-component*/
